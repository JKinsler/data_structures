...
def unique_houses(filename):
    ...
    for line in house_data:
        ...
        # print(person_info)
        if person_info[2] == "":
            blanks.append(person_info[2])
        else:
            houses.append(person_info[2])
...
#         # print(person_info)
        ...
        if new_cohort == "":
            blanks.append(person_info[0] + " " + person_info[1])
        if new_cohort == "Winter 2016":
            winter_16.append(person_info[0] + " " + person_info[1])
        if new_cohort == "Spring 2016":
            spring_16.append(person_info[0] + " " + person_info[1])
        if new_cohort == "Summer 2016":
            summer_16.append(person_info[0] + " " + person_info[1])
        if new_cohort == "Fall 2015":
            fall_15.append(person_info[0] + " " + person_info[1])
        if new_cohort == "G":
            ghosts.append(person_info[0] + " " + person_info[1])
            #print(ghosts)
